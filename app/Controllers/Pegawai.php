...
class Pegawai extends Controller{
    ...
    public function progres_add_pegawai()
    {
        if(session()->get('level') == 3) 
        {
            ...
            if (!$this->validate([
                ...
                'level' => [
                    'rules' => 'required',
                    'errors' => [
                        'required'   => 'Level Pengguna Harus di Pilih.',   
                    ]
                ], 
            ])) {
            ...
            if ($new_id_users) { 
                $Users->insert([ 
                    ...
                    'level_users' => $this->request->getVar('level'),
    ...
    public function a_del_pegawai()
    {
        if (session()->get('level') == 3) 
        {
            ...
            echo '
                <form action="'.base_url().'/pegawai/del" method="post" enctype="multipart/form-data">
    ...
    public function progres_del_pegawai()
    {
        if(session()->get('level') == 3)
        {
    ...
    public function a_edit_pegawai()
    {
    ...
    public function p_edit_pegawai()
    {
        if(session()->get('level') == 3) 
        {
