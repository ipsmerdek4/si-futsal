                        ...
                        <div class="col-lg-12  ">
                             <div class="card">
                                ...
                                <div class="card-content card-title-spc">
                                    <h4 class="card-title title-spc">Pegawai</h4>
                                    <hr> 
                                        ...
                                        <tbody>
                                            <?php  
                                                foreach ($dataIdentitas as $v_dataIdentitas): 
                                                    if ($v_dataIdentitas->level_users > 1) { 
                                            ?>  
                                            <tr>
                                                <td> </td>
                                                <td>
                                                ...
                                                <td style="width:70px !important;">
                                                    <b>
                                                    <?php
                                                        if ($v_dataIdentitas->level_users == 2) {
                                                           echo '
                                                            <button class="btn btn-primary btn-xs " style="text-transform:none; font-weight: bold;font-size: 12px;letter-spacing:1px;" >
                                                                <b> Staff </b>
                                                            </button>
                                                           ';
                                                        }elseif ($v_dataIdentitas->level_users == 3) {
                                                            echo'
                                                            <button class="btn btn-primary btn-xs " style="text-transform:none; font-weight: bold;font-size: 12px;letter-spacing:1px;" >
                                                                <b> Admin </b> 
                                                            </button>
                                                                ...
                                                                <div class="col-md-6"> 
                                                                    <div class="input-group">
                                                                        ...
                                                                        <div class="form-group label-spcs">
                                                                            ...
                                                                            <select name="level" id="level" class="box-p-spc select-drop-input"  style="width:100%" >
